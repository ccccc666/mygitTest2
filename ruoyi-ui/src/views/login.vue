<template>
  <div class="login">
    ...
    <div class="el-login-footer">
      <span>Commercial business management system</span>
    </div>
  </div>
</template>
      ...
      class Matrix {
        ...
        static canvasDraw() {
          ...
          this.words.map((item,index) => {
            ...
            this.textX = index * 10;
            this.ctx.fillText(this.text, this.textX, item);
            this.words[index] = (item > 758 + Math.random() * 484 ? 0 : item + 10);
          });
        };
        static initCanvas(){
